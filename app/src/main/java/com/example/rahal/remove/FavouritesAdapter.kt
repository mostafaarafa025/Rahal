...
class FavouritesAdapter: RecyclerView.Adapter<FavouritesAdapter.ViewHolder>() {
    ...
    class ViewHolder(var viewBinding: CustomRectangleItemForRecylerViewBinding):
        RecyclerView.ViewHolder(viewBinding.root)


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = CustomRectangleItemForRecylerViewBinding.inflate(LayoutInflater.from(parent.context),parent,false)
